...
return [
    ...
    'global.plan_settings.stores_limit' => '%s properties',
    'global.plan_settings.menus_limit' => '%s guide per property',
    ...
    's_store.breadcrumb' => 'Back',
    's_store.menus' => 'Menus',
    's_store.view_menu' => 'View',
    's_store.email' => 'Email us',
    's_store.website' => 'Our website',
    's_store.open' => 'Open Now',
    's_store.closed' => 'Closed',

    's_store.password.title' => 'Password protected guestbook',
    's_store.password.header' => 'Password protected guestbook',
    's_store.password.subheader' => 'You must input the correct password to see the content of the guestbook. Your password will be remembered for 30 days.',
    's_store.password.error_message' => 'The password is incorrect!',
    ...
    'domains.subheader' => 'Here you can add your own custom domain to use with your guidebook.',
    ...
    'dashboard.stores_total' => 'Properties',
    'dashboard.orders_total' => 'Guidebooks',
    'dashboard.stores_pageviews' => 'Guidebook pageviews',
    'dashboard.filters.name' => 'Name',
    'dashboard.filters.pageviews' => 'Pageviews',
    'dashboard.filters.orders' => 'Orders',
    'dashboard.no_data' => 'There are no created properties',
    'dashboard.no_data_help' => 'Start by adding your first property.',
    ...
    'stores.title' => 'Guidebook sections',
    'stores.menu' => 'Dashboard',
    'store.breadcrumb' => 'Sections',
    'store.title' => '%s - Sections',
    'store.menu' => ' Guidebook sections',
    'store.header' => '%s property',
    'store.create' => 'Add property',
    'store.external_url' => 'View guidebook',
    'store.orders_label' => 'Orders',
    'store.value_label' => 'Value',
    'store.stores' => 'Properties',
    ...
    'store.pageviews' => '%s Guidebook views',

    'store.input.domain_id' => 'Domain',
    'store.input.domain_id_help' => 'Select the domain that you\'d like to use to create your guidebook with.',
    'store.input.is_main_store' => 'Exclusive store for this custom domain',
    'store.input.is_main_store_help' => 'Make this guidebook to be accessible via the index of this custom domain. Other guidebooks won\'t be able to be associated with this domain after.',
    'store.input.url' => 'URL Alias',
    'store.input.url_placeholder' => 'my-awesome-guidebook',
    'store.input.url_help' => 'The main URL that your guidebook is going to be able accessed from.',
    'store.input.name' => 'Property name',
    'store.input.name_placeholder' => 'My awesome hotel',
    'store.input.title' => 'Page title',
    'store.input.title_help' => 'Short & descriptive title of your property.',
    'store.input.description' => 'Description',
    'store.input.description_help' => 'Short description of your property.',
    'store.input.logo' => 'Logo',
    'store.input.logo_help' => 'Your property\'s logo, recommended 1:1 (square) ratio for the logo.',
    'store.input.favicon' => 'Favicon',
    'store.input.favicon_help' => 'Your property\'s favicon, recommended 1:1 (square) ratio for the favicon.',
    'store.input.image' => 'Cover photo',
    'store.input.custom_css' => 'Custom CSS',
    'store.input.custom_css_help' => 'Custom CSS to overwrite the already existing guidebook style.',
    'store.input.custom_js' => 'Custom JS',
    'store.input.custom_js_help' => 'You could add your own tracking javascript code to the guidebook, for example.',
    'store.input.email_reports_is_enabled' => 'Email reports',
    'store.input.email_reports_is_enabled_help' => 'Get casual analytics email reports of your guidebook.',
    ...
    'store.input.whatsapp_number'=> 'Whatsapp Number',
    'store.input.whatsapp_number_placeholder' => 'Whatsapp Number',
    ...
    'store.input.password_help' => 'Require visitors to enter a password to see the content of the guidebook.',
    ...
    'store.input.timezone_help' => 'Main timezone of the property.',
    ...
    'store.input.is_enabled' => 'Guidebook is enabled',
    'store.input.is_enabled_help' => 'The main switch that keeps the guidebook working.',
    'store.input.is_se_visible' => 'Search Engine visibility',
    'store.input.is_se_visible_help' => 'If disabled, the guidebook will not be indexed by search engines, such as Google or Bing.',
    'store.input.is_removed_branding' => 'Remove branding',
    'store.input.is_removed_branding_help' => 'If enabled, the guidebook won\'t show the branding of our website.',
    ...
    'store_create.breadcrumb' => 'Add property',
    'store_create.title' => 'Add property',
    'store_create.header' => 'Add a new property',
    'store_create.info' => 'You can set up more details about the property after the creation.',


    'store_update.breadcrumb' => 'Edit property',
    'store_update.title' => '%s - Edit property',
    ...
    'store_update.socials' => 'Contact info',
    'store_update.advanced' => 'Advanced',
    'store_update.seo' => 'Seo',


    'store_qr.breadcrumb' => 'Property QR',
    'store_qr.title' => '%s - Property QR code',
    'store_qr.menu' => 'QR Code',
    'store_qr.header' => '%s property QR code',
    'store_qr.subheader' => 'This QR code is meant to be downloaded, printed and placed onto where your guests can see and access it.',
    ...
    'orders.breadcrumb' => 'Property orders',
    'orders.title' => '(%1$s pending orders) - Property orders - %2$s',
    'orders.menu' => 'Orders',
    'orders.header' => '%s property orders',
    ...
    'menus.title' => 'Sections',
    'menu.breadcrumb' => 'Section',
    'menu.title' => 'Section - %s',
    'menu.menu' => 'Section',
    'menu.header' => '%s section',
    'menu.create' => 'Create section',
    'menu.external_url' => 'View section',
    'menu.menus' => 'Sections',
    'menu.datetime' => 'Created on %s',
    'menu.pageviews' => '%s Pageviews',

    'menu.input.url' => 'URL Alias',
    'menu.input.url_placeholder' => 'section-name',
    'menu.input.url_help' => 'The URL where this section is going to be able accessed from.',
    'menu.input.name' => 'Section name',
    'menu.input.name_placeholder' => 'My awesome section',
    'menu.input.description' => 'Description',
    'menu.input.description_help' => 'Short description of this section.',
    'menu.input.image' => 'Section cover image',
    'menu.input.is_enabled' => 'Section is enabled',
    'menu.input.is_enabled_help' => 'Easily enable or disable the section completely. Disabled sections would not show up on your guidebook',

    'menu.error_message.url_exists' => 'This section already exists. Please choose a new one!',
    'menu.no_data' => 'There are no created categories for this section',
    'menu.no_data_help' => 'Start by creating your first category.',

    'menu_create.breadcrumb' => 'Create a section',
    'menu_create.title' => 'Create section',
    'menu_create.header' => 'Create a new section',

    'menu_update.breadcrumb' => 'Edit section',
    'menu_update.title' => 'Edit section - %s',

    'menu.input.welcome_msg_main' => 'Welcome Message',
    'menu.input.welcome_msg' => 'Welcome your guest with details about your property',
   

    'menu.input.directions_main' => 'Directions',
    'menu.input.directions' => 'Give directions to your property',

    'menu.input.bring_along_main' => 'Bring along',
    'menu.input.bring_along' => 'Tell your guests if they need to bring alomg anything specific',

    'menu.input.rules_main' => 'Rules',
    'menu.input.rules' => "Describe to your guest about the do's and don'ts at your property",

    'menu.input.network' => 'Network name',
    'menu.input.network_password' => 'Password',
    'menu.input.add_notes' => 'Additional note',

    'menu.input.emergency' => 'Emergency Service Name',
    'menu.input.emergency_call' => 'Number to call during emergencies',
    'menu.input.emergency_add_notes' => 'Additional note',

    'menu.input.check_in' => 'Check In',
    'menu.input.check_out' => 'Check Out',
    'menu.input.check_in_out_add_notes' => 'Additional note',
    
    'menu.input.healthe_service_name' => 'Health Service',
    'menu.input.healthe_service_speciality' => 'Speciality',
    'menu.input.healthe_service_website' => 'Website',
    'menu.input.healthe_service_contact_no' => 'Contact number',
    'menu.input.healthe_service_contact_email' => 'Contact email',
    'menu.input.healthe_service_walking_distance' => 'Walking distance (in Minutes)',
    'menu.input.healthe_service_driving_distance' => 'Driving distance (in Minutes)',
