...
<?php endif ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><?= sprintf(l('global.update_x'), $data->item_option->name) ?></h1>
    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="options"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('item_option.input.options') ?></label>
