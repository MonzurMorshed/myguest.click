...
<html lang="<?= \Altum\Language::$code ?>" dir="<?= l('direction') ?>">
    ...
    <?php endif ?>
        ...
        <?php foreach(['custom.css', 'libraries/select2.css','libraries/quill.snow.css?v=3200'] as $file): ?>
    ...
    <body class="<?= l('direction') == 'rtl' ? 'rtl' : null ?> app <?= \Altum\ThemeStyle::get() == 'dark' ? 'cc--darkmode' : null ?>" data-theme-style="<?= \Altum\ThemeStyle::get() ?>">
        ...
        <?php foreach(['libraries/jquery.slim.min.js', 'libraries/popper.min.js', 'libraries/bootstrap.min.js', 'custom.js', 'libraries/fontawesome.min.js', 'libraries/fontawesome-solid.min.js', 'libraries/fontawesome-brands.modified.js', 'libraries/select2.js','libraries/quill.min.js'] as $file): ?>
