    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-4">
        <div class="d-xl-none">
            <select name="settings_menu" class="custom-select">
                ...
                <option value="<?= url('admin/settings/stores') ?>" class="nav-link" <?= $data->method == 'stores' ? 'selected="selected"' : null ?>><?= l('admin_settings.stores.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'stores' ? 'active' : null ?>" href="<?= url('admin/settings/stores') ?>"><i class="fas fa-fw fa-sm fa-store mr-2"></i> <?= l('admin_settings.stores.tab') ?></a>
