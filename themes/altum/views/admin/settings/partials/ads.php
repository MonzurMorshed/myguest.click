...
<div>
    ...
    <div class="form-group">
        ...
        <textarea id="header_stores" name="header_stores" class="form-control"><?= settings()->ads->header_stores ?></textarea>
    </div>

    <div class="form-group">
        <label for="footer_stores"><?= l('admin_settings.ads.footer_stores') ?></label>
        <textarea id="footer_stores" name="footer_stores" class="form-control"><?= settings()->ads->footer_stores ?></textarea>
    </div>
</div>
