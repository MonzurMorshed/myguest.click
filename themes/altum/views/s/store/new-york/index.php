...
<div class="container my-4">
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <?php if(!empty($data->store->details->whatsapp_number)): ?>
        <a href="<?= "https://wa.me/".$data->store->details->whatsapp_number ?>" target="_blank" class="col-12 col-lg-2 mb-3 mb-lg-0 mr-3 text-truncate btn btn-sm btn-link bg-primary-100">
            <div class="svg-sm mr-1 d-inline-block"><?= include_view(ASSETS_PATH . 'images/s/whatsapp.svg') ?></div> <span>Chat</span>
        </a>
        <?php endif ?>
