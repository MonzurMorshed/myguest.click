...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li>
                    <a href="<?= url('orders/' . $data->store->store_id) ?>"><?= l('orders.breadcrumb') ?></a><i class="fas fa-fw fa-angle-right"></i>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-cog text-muted mr-1"></i> <?= l('order.type') ?>
                    </small>
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-stream text-muted mr-1"></i> <?= l('global.status') ?>
                    </small>

                    <span>
                        <?php if($data->order->status): ?>
                            <span class="badge badge-success">
                                <i class="fas fa-fw fa-sm fa-check mr-1"></i> <?= l('order.status_complete') ?>
                            </span>
                        <?php else: ?>
                            <span class="badge badge-warning">
                                <i class="fas fa-fw fa-sm fa-clock mr-1"></i> <?= l('order.status_pending') ?>
                            </span>
                        <?php endif ?>
                    </span>
                </div>
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-list-ol text-muted mr-1"></i> <?= l('order.ordered_items') ?>
                    </small>
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-money-check-alt text-muted mr-1"></i> <?= l('order.processor') ?>
                    </small>
                ...
                <?php if(in_array($data->order->processor, ['stripe', 'paypal', 'mollie'])): ?>
                    <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                        <small class="text-muted font-weight-bold mb-2">
                            <i class="fas fa-fw fa-sm fa-dollar-sign text-muted mr-1"></i> <?= l('order.is_paid') ?>
                        </small>

                        <span>
                        <?php if($data->order->is_paid): ?>
                            <span class="badge badge-success">
                                <i class="fas fa-fw fa-sm fa-check mr-1"></i> <?= l('global.yes') ?>
                            </span>
                        <?php else: ?>
                            <span class="badge badge-warning">
                                <i class="fas fa-fw fa-sm fa-times mr-1"></i> <?= l('global.no') ?>
                            </span>
                        <?php endif ?>
                    </span>
                    </div>
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-calendar text-muted mr-1"></i> <?= l('order.datetime') ?>
                    </small>
    ...
    <div class="card my-5">
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('order.name') ?>
                    </small>
                ...
                <?php if($data->order->type == 'on_premise'): ?>
                    <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                        <small class="text-muted font-weight-bold mb-2">
                            <i class="fas fa-fw fa-sm fa-sort-numeric-up-alt text-muted mr-1"></i> <?= l('order.number') ?>
                        </small>
                ...
                <?php if($data->order->type == 'takeaway' || $data->order->type == 'delivery'): ?>
                    <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                        <small class="text-muted font-weight-bold mb-2">
                            <i class="fas fa-fw fa-sm fa-phone-square-alt text-muted mr-1"></i> <?= l('order.phone') ?>
                        </small>
                ...
                <?php if($data->order->type == 'delivery'): ?>
                    <div class="col-12 col-lg-6 col-xl-4 d-flex flex-column mb-4">
                        <small class="text-muted font-weight-bold mb-2">
                            <i class="fas fa-fw fa-sm fa-map text-muted mr-1"></i> <?= l('order.address') ?>
                        </small>
                ...
                <div class="col-12 d-flex flex-column">
                    <small class="text-muted font-weight-bold mb-2">
                        <i class="fas fa-fw fa-sm fa-paragraph text-muted mr-1"></i> <?= l('order.message') ?>
                    </small>
    ...
    <div class="my-5">
            ...
            <div class="my-3 rounded p-3 bg-gray-50">
                <div class="row">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="order-item-image-wrapper mr-3">
                                <?php if($order_item->item_id && $order_item->data->image): ?>
                                    <img src="<?= \Altum\Uploads::get_full_url('item_images') . $order_item->data->image ?>" class="order-item-image-background" loading="lazy" />
                                <?php endif ?>
                            </div>
                    ...
                    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end order-0 order-lg-1">
                        <div>
                            <span class="font-weight-bold"><?= nr($order_item->price, 2) ?></span> <span class="text-muted"><?= $data->store->currency ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between bg-primary-100 p-3 rounded my-4">
            ...
            <div>
                <span class="font-weight-bold"><?= nr($data->order->price, 2) ?></span> <span class="text-muted"><?= $data->store->currency ?></span>
            </div>
        </div>
